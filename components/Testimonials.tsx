      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
            {TESTIMONIALS.map((testimonial) => (
                <div key={testimonial.id} className="w-full md:w-[350px] flex flex-col group">
                    ...
                    <div className="relative aspect-[3/4] w-full bg-zinc-900 overflow-hidden mb-6 shadow-2xl shadow-black">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-16 h-16 rounded-full border border-white/30 bg-black/30 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform duration-300 cursor-pointer">
